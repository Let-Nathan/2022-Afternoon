 ...
 */
final class Version20220721192844 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidate ADD domains_id INT DEFAULT NULL, ADD disponibilities_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE candidate ADD CONSTRAINT FK_C8B28E443700F4DC FOREIGN KEY (domains_id) REFERENCES domain (id)');
        ...
        $this->addSql('CREATE INDEX IDX_C8B28E443700F4DC ON candidate (domains_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE candidate_domain (candidate_id INT NOT NULL, domain_id INT NOT NULL, INDEX IDX_139A40D791BD8781 (candidate_id), INDEX IDX_139A40D7115F0EE5 (domain_id), PRIMARY KEY(candidate_id, domain_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE candidate DROP FOREIGN KEY FK_C8B28E443700F4DC');
        $this->addSql('ALTER TABLE candidate DROP FOREIGN KEY FK_C8B28E442443ED83');
        $this->addSql('DROP INDEX IDX_C8B28E443700F4DC ON candidate');
        $this->addSql('DROP INDEX IDX_C8B28E442443ED83 ON candidate');
        $this->addSql('ALTER TABLE candidate DROP domains_id, DROP disponibilities_id');
    }
}
